...
<head>
    ...
    <![endif]-->    
    <title>Upload a Top Story Article</title>
</head>
<?php echo validation_errors(); ?>

<?php echo form_open_multipart('upload/do_uploadtopstory'); //this is name of the controller followed by the method that handles form posts.?>

<div class="card">
    <div class="card-body">    

    <div class="card-header"><p class="h4 text-center mb-4">Advert Upload</p></div>

    <label for="" class="grey-text">Ad Title</label>
