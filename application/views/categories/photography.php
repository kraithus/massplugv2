      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <!-- Column 1 -->
              <?php foreach ($photography_news as $news_item): 
              ...
              <div class="col-md-3 col-sm-6">
                ...
                <article class="article">
                  <div class="article-img">
                    <a href="<?php echo site_url('photography/'.$news_item['slug']); ?>">
                  ...
                  <div class="article-body">
                    <h4 class="article-title"><a href="<?php echo site_url('photography/'.$news_item['slug']); ?>"><?php echo $news_item['title']?></a></h4>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="footer-widget">
                ...
                <!-- ARTICLEx3 -->
                <?php foreach ($technology_limit3 as $news_item):
                $time_stamp = $news_item['time_stamp'];
                $unix_time = mysql_to_unix($time_stamp);
                ?>
            ...
            <div class="col-md-4">
              ...
              <ul>
                <?php foreach ($fashion_limit8 as $news_item): ?>
