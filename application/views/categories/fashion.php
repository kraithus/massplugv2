        ...
        <div class="container">
          <nav id="main-nav">
            ...
            <ul class="main-nav nav navbar-nav">
                    ...
                    <li class="active"><a href="<?php echo site_url();?>categories/fashion">Fashion</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <!-- Column 1 -->
              <?php foreach ($fashion_news as $news_item): 
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="footer-widget">
                ...
                <!-- ARTICLEx3 -->
                <?php foreach ($lifestyle_limit3 as $news_item): 
                $time_stamp = $news_item['time_stamp'];
                $unix_time = mysql_to_unix($time_stamp);
                ?>                
