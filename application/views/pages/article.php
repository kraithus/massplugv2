    ...
    <div class="row">
      <div class="col-lg-12 col-md-12">
        ...
        <div class="header_bottom">
          <div class="header_bottom_left"><a class="logo" href="../news/index.php">Mass<strong>Plug</strong> <span>Your trusted plug</span></a></div>
          //can place an add image here...<div class="header_bottom_right"><a href="#"><img src="" alt=""></a></div>
        </div>
      </div>
    </div>
  </header>
