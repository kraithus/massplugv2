...
<html lang="en">
  <head>
    ...
    <title>MassPlug - Search Results</title>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <!-- Column 1 -->
              <?php foreach ($retrieve as $news_item): 
            ...
            <div class="col-md-4">
              ...
              <div class="footer-widget about-widget">
                <div class="footer-logo">
                  <a href="<?php echo base_url();?>" class="logo"><img src="<?php echo base_url();?>images/logo-white-red.png" alt="logo"></a>
