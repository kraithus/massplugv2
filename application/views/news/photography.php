<?php
$time_stamp = $galler_item['time_stamp'];
...
<html lang="en">
  <head>
    ...
    <title>MassPlug - Photography</title>
        ...
        <div class="container-fluid row">
          <nav id="main-nav">
            ...
            <ul class="main-nav nav navbar-nav">
              ...
              <li class="active"><a href="<?php echo site_url();?>categories/photography">Photography</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <ul class="article-breadcrumb">
              <li><a href="<?php echo site_url();?>">Home</a></li>
              <li><a href="<?php echo site_url();?>categories/<?php echo $galler_item['category']?>"><?php echo $galler_item['category']?></a></li> 
              <li><?php echo $galler_item['title']?></li>
            </ul>
            <!-- /breadcrumb -->
            ...
            <article class="article article-post">
              ...
              <div class="article-main-img">
                <img src="<?php echo base_url();?>uploads/<?php echo $galler_item['data_file'];?>" alt="">
              </div>
              <div class="article-body">
                <ul class="article-info">
                  <li class="article-category"><a href="<?php echo site_url();?>categories/<?php echo $galler_item['category']?>"><?php echo $galler_item['category']?></a></li>
                  <li class="article-type"><i class="fa fa-camera"></i></li>
                </ul>
                <h1 class="article-title"><?php echo $galler_item['title']?></h1>
                <ul class="article-meta">
                  <li><i class="fa fa-clock-o"></i> <?php echo timespan($unix_time, $now, $units)?> ago</li>
                  <li><i class="fa fa-clock-o"> <?php echo date("l, dS F Y", strtotime($time_stamp))?></i> </li>
                </ul>
                <p><?php echo $galler_item['article']?></p>
              </div>
            </article>
            <!-- /ARTICLE POST -->
            ...
            <div class="article-comments">
              ...
              foreach ($galler_comments as $com):
            ...
            <div class="article-reply-form">
              ...
              <?php echo form_open_multipart('comment/minor_galler_comment');?>
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6">
                ...
                <article class="article">
                  <div class="article-img">
                    <a href="<?php echo site_url();?>photography/<?php echo $news_item['slug']?>">
                  ...
                  <div class="article-body">
                    <h4 class="article-title"><a href="<?php echo site_url();?>photography/<?php echo $news_item['slug']?>"><?php echo $news_item['title']?></a></h4>
                    <ul class="article-meta">
                      <li><i class="fa fa-clock-o"></i> <?php echo timespan($unix_time, $now, $units)?> ago</li>
                      <li><i class=""></i> </li>
                    </ul>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <ul>
                <?php foreach ($music_limit8 as $news_item): ?>
                <li><a href="<?php echo site_url('article/'.$news_item['slug']); ?>"><img class="thumb-square-small cover-object-fit" src="<?php print HTTP_UPLOAD_MOBILE_PATH.($news_item['data_file'])?>" alt=""></a></li>
                <?php endforeach ?>
              </ul>
              </div>
              <!-- /footer galery -->
